...
Choose one federal acquisition job and install one self-contained agent package. Market Research is at `1.0.0-rc.12`; Pre-Award is at `1.0.0-rc.8`; GovCon Growth is at `1.0.0-rc.9`; Other Transaction is at `1.0.0-rc.8`; Acquisition Policy is at `1.0.0-rc.4`. All five are installable public previews. The repository marketplace release is `v1.2.0-rc.14`.
