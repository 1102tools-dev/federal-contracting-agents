...
The bundled `govcon-growth-workflow` runtime is synchronized from `federal-contracting-skills` commit `c1260bb7f7104cacb731f3c3c2a483af67b16c8d`. Its canonical `test.md` records:
