...
Package: `pre-award-agent` `1.0.0-rc.2`
...
| Surface | Result |
|---|---|
| Codex CLI | Clean `1.0.0-rc.2` marketplace installation, package inventory, skill discovery, and MCP discovery passed; the `rc.1` explicit routing, natural-language routing, and post-install boundary evidence remains applicable because the runtime components are unchanged |
